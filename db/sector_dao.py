...
class SectorDao(Dao):
    ...
    def update_sector_by_id(self, sector_id, sector):
        with self.db.cursor(dictionary=True) as cursor_update_sector_by_id:
    ...
    def delete_sector_by_id(self, sector_id):
        with self.db.cursor(dictionary=True) as cursor_delete_sector_by_id:
    ...
    def create_sector(self, sector_id, sector):
        with self.db.cursor(dictionary=True) as cursor_create_sector:
